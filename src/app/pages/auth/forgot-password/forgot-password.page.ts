...
import { Component, OnInit, inject } from '@angular/core'; // Importa Component, OnInit, e inject de Angular.
import { FormControl, FormGroup, Validators } from '@angular/forms'; // Importa clases de Angular para formularios.
